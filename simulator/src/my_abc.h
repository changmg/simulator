...
public:
    ...
    void TopoSortRecWithIds(abc::Abc_Obj_t * pObj, std::vector <ll> & nodes) const;
    ...
    std::vector <ll> TempRepl(abc::Abc_Obj_t * pTS, abc::Abc_Obj_t * pSS);
    ...
    inline ll GetPiNum() const {return abc::Abc_NtkPiNum(GetNet());}
    inline ll GetObjNumMax() const {return abc::Abc_NtkObjNumMax(GetNet());}
    inline ll GetObjNum() const {return abc::Abc_NtkObjNum(GetNet());}
    inline ll GetPoNum() const {return abc::Abc_NtkPoNum(GetNet());}
    inline ll GetNodeNum() const {return abc::Abc_NtkNodeNum(GetNet());}

    inline abc::Abc_Obj_t * GetPi(ll i) const {return abc::Abc_NtkPi(GetNet(), i);}
    inline abc::Abc_Obj_t * GetObj(ll i) const {return abc::Abc_NtkObj(GetNet(), i);}
    inline abc::Abc_Obj_t * GetPo(ll i) const {return abc::Abc_NtkPo(GetNet(), i);}

    inline ll GetIdMaxPlus1() const {return abc::Abc_NtkObjNumMax(GetNet());}
    inline ll GetIdMax() const {return abc::Abc_NtkObjNumMax(GetNet()) - 1;}
    inline ll GetId(abc::Abc_Obj_t * pObj) const {return abc::Abc_ObjId(pObj);}
    ...
    inline ll GetFaninNum(abc::Abc_Obj_t * pObj) const {return abc::Abc_ObjFaninNum(pObj);}
    inline ll GetFaninNum(ll id) const {return GetFaninNum(GetObj(id));}
    inline abc::Abc_Obj_t * GetFanin(abc::Abc_Obj_t * pObj, ll i) const {return abc::Abc_ObjFanin(pObj, i);}
    inline abc::Abc_Obj_t * GetFanin(ll id, ll i) const {return GetFanin(GetObj(id), i);}
    inline ll GetFaninId(abc::Abc_Obj_t * pObj, ll i) const {return GetId(GetFanin(pObj, i));}
